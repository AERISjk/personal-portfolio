...
export const Timeline = ({ data }: { data: TimelineEntry[] }) => {
  ...
  return (
    <div
      className="w-full bg-black dark:bg-neutral-950 md:px-10"
      ref={containerRef}>
      <div className="max-w-7xl mx-auto py-20 px-4 md:px-8 lg:px-10 text-white">
        <h1 className="pb-6 font-bold tracking-tight text-5xl md:text-6xl lg:text-7xl">
          Work Experience
        </h1>

        <p className="text-neutral-300 dark:text-neutral-300 text-sm md:text-base max-w-sm">
          Below is a visual timeline of my journey, showcasing the work I've
          dedicated myself to.
        </p>
      </div>
